...
const ACCOUNTS = [
  ...
  { role: "OFFICER", label: "Officers", items: [
    ...
    { email: "kiran@roads.gov.in", name: "Kiran Shetty (Roads)" },
    { email: "meera@roads.gov.in", name: "Meera Pillai (Roads)" },
    { email: "ganesh@sanitation.gov.in", name: "Ganesh Verma (Sanitation)" },
    { email: "divya@sanitation.gov.in", name: "Divya Menon (Sanitation)" },
    { email: "prakash@revenue.gov.in", name: "Prakash Joshi (Revenue)" },
    { email: "shobha@revenue.gov.in", name: "Shobha Rani (Revenue)" },
    { email: "naveen@genadmin.gov.in", name: "Naveen Chandra (General)" },
    { email: "farida@genadmin.gov.in", name: "Farida Khan (General)" },
  ]},
